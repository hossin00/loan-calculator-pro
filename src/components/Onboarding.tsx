...
const SLIDES=[{"accent": "#34d399", "icon": "\ud83c\udfe6", "title": "Calculate loan\npayments instantly", "desc": "Enter amount, rate, and term. Get monthly EMI and total interest instantly."}, {"accent": "#10b981", "icon": "\ud83d\udcca", "title": "Full amortization\nschedule", "desc": "See every monthly payment broken into principal and interest."}, {"accent": "#059669", "icon": "\ud83d\udcb0", "title": "Compare multiple\nloan scenarios", "desc": "Side-by-side comparison to find the best loan deal."}];
  ...
  return (
    <div style={{minHeight:'100vh',display:'flex',flexDirection:'column',background:'#08080f',position:'relative'}}>
      ...
      <div style={{padding:'20px 24px',display:'flex',justifyContent:'flex-end'}}>
        <button onClick={onDone} style={{color:'#34d39950',fontSize:'14px',background:'none',border:'none',cursor:'pointer',fontFamily:'Inter'}}>Skip</button>
      </div>
      <div key={idx} style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'20px 32px',textAlign:'center',animation:'sIn .35s ease'}}>
        ...
        <p style={{color:'#34d39970',fontSize:'14px',lineHeight:'1.7',maxWidth:'270px'}}>{slide.desc}</p>
      </div>
